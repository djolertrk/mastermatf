...
U radu će detaljno biti obrađen rad UNIX-olikih, posebno Linux debagera.
Windows debageri i programski prevodioci ne prate standard DWARF\cite{DWARF} prilikom baratanja sa debag informacijama namenjene za taj operativni sistem, već isti konsultuju standard \emph{Majkrosoft CodeView}, više informacija možete pronaći na \cite{CodeView}.
...
Nakon fajl formata ELF, jako bitan fajl format je DWARF, koji predstavalja format zapisa debag informacija koje debageri koriste kada analiziraju programe. DWARF je od posebne važnosti za rad te će isti biti opisan detaljno u nastavku.
