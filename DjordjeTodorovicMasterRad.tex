...
Definišimo neke od osnovnih pojmova Linux programiranja koje ćemo često pominjati u radu.
...
Pored instrukcijkog koračanja pomenućemo još jednu vrstu zakoračavanja u neku funkciju koja je pozvana \texttt{call} ili \texttt{jump} instrukcijom. Komanda debagara GNU GDB koja nam to omogućava jeste \texttt{step in}.
