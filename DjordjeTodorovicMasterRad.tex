...
Pre izmene rezultati izvršavanja testova \emph{Multiarch} GNU GDB verzije alata:

 
Posle izmene rezultati izvršavanja testova \emph{Multiarch} GNU GDB verzije alata:
