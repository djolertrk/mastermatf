...
Na slici \ref{fig:core1} je prikazan primer korišćenja alata \emph{Multiarch} GNU GDB. U primeru se vrši učitavanje datoteke jezgra generisane na uređaju sa ugrađenim računarom arhitekture MIPS. Uz datoteku jezgra učitavaju se izvršni fajl i deljene biblioteke koje izvršni fajl koristi na ciljanoj platfomi.
...
\begin{figure}[h!]
	...
	\end{center}
	\caption{Primer čitanja vrednosti registara korišćenjem \emph{Multiarch} GNU GDB iz datoteke jezgra generisane na MIPS platformi.}
	\label{fig:core2}
\end{figure}
